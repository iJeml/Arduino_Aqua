...
#define Lamp_aq 24     // donde se encuentra conectado el modulo de rele que corresponde a pin digital 30
#define Lamp_aq2 23    // donde se encuentra conectado el modulo de rele que corresponde a pin digital 31 (desocupado)
...
void setup () {
 ...
 pinMode(Lamp_aq, OUTPUT);   // pin 52 para las luces secundarias
